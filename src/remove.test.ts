      ...
      JSON.stringify({
        ...
        plugins: {
          'managed-plugin': {
            ...
            source: 'owner/repo',
            sourceType: 'github',
            rootPath: 'plugins/managed-plugin',
            installedPath: 'plugins/managed-plugin',
            locator: { source: 'local', path: './plugins/managed-plugin' },
            installedAt: '2026-05-12T00:00:00.000Z',
            updatedAt: '2026-05-12T00:00:00.000Z',
          },
        },
      ...
      JSON.stringify({
        ...
        plugins: {
          'hide-secrets@agent-marketplace': {
            ...
            rootPath: '/tmp/hide-secrets',
            locator: { source: 'local', path: '/tmp/hide-secrets' },
            installedAt: '2026-05-12T00:00:00.000Z',
            updatedAt: '2026-05-12T00:00:00.000Z',
          },
        },
