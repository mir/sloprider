...
import { readMcpLock } from './mcp-lock.ts';
import { readHookLock } from './hook-lock.ts';
import { listCodexMarketplacePlugins } from './plugin-marketplace.ts';
import { readPluginRegistry } from './plugin-registry.ts';
import type { PluginSourceDescriptor } from './types.ts';
...
function marketplaceSource(source: PluginSourceDescriptor): string | null {
